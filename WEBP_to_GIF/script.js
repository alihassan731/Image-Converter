...
function convertToGif() {
  if (translator == "") {
    alert("Please select the image before Convert GIF");
  } else {
    displayConvertedGif();
...
function displayConvertedGif() {
  ...
  if (existingImg) {
    existingImg.src = translator.replace("data:image/webp", "data:image/gif");
  }
}
...
function downloadBtn() {
  let result = translator.replace("data:image/webp", "data:image/gif");
